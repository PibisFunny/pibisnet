    ...
    function generateCombos() {
      const displayOptions = ['singleCharacter', 'vowelConsonant', 'consonantVowelConsonant'];
      ...
      randomCharElement.textContent = `${result.charAt(0).toUpperCase()}${result.slice(1).toLowerCase()}ario`;
